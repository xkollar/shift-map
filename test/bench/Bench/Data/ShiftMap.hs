...
benchmarks = env setupEnv $ \_ -> bgroup "Bench.Data.ShiftMap"
    ...
    , bench "shiftInsert on big" $ nf (shiftInsert 1 ()) fixture2to16
    , bench "shiftDelete on big" $ nf (shiftDelete 1) fixture2to16
    , bench "size on big" $ nf size fixture2to16
    ]
